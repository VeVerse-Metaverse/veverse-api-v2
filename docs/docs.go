        ...
        "/placeable_classes": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Specify to filter by the portal, destination portal, destination space or destination metaverse name",
                        "name": "query",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "model.File": {
            ...
            "properties": {
                ...
                "originalPath": {
                    "description": "original relative path to maintain directory structure (e.g. for releases)",
                    "type": "string"
                },
                "platform": {
